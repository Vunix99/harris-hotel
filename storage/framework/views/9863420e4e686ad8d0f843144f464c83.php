                ...
                <div class="container container-1720 clearfix">
                    ...
                    <div class="header-inner rel d-flex align-items-center justify-content-between">
                        ...
                        <div class="menu-btns">
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="theme-btn">Login <i
                    ...
                    <?php $__currentLoopData = $kamars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kamar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-xl-4 col-md-6">
                            <div class="room-item style-two wow fadeInUp delay-0-2s">
                                ...
                                <div class="content">
                                    <h4><a
                                            href="<?php echo e(route('room-details', ['id' => $kamar->id])); ?>"><?php echo e($kamar->nama); ?></a>
                                    </h4>
                                    <?php if($kamar->gambar): ?>
                                ...
                                <a class="theme-btn" href="<?php echo e(route('room-details', ['id' => $kamar->id])); ?>">Book
                                    Now
...
<?php /**PATH /home/glo/Documents/DokumenAne/harris-hotel/resources/views/index.blade.php ENDPATH**/ ?>