            ...
            <div class="header-inner rel d-flex align-items-center justify-content-between">
                <div class="logo-outer">
                    <div class="logo"><a href="<?php echo e(url('/')); ?>"><img
                                src="<?php echo e(asset('https://www.discoverasr.com/content/dam/tal/common/assets/logos/brands/tauzia/harris/harris-logo-132x80.png')); ?>"
                ...
                <div class="menu-btns">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <a href="<?php echo e(route('logout')); ?>" class="theme-btn"
                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                            Logout <i class="far fa-angle-right"></i>
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="theme-btn">Login <i class="far fa-angle-right"></i></a>
                    <?php endif; ?>
                    <!-- menu sidebar -->
                </div>
            </div>
...
<!--End Hidden Sidebar -->
<?php /**PATH /home/glo/Documents/DokumenAne/harris-hotel/resources/views/partials/navbar.blade.php ENDPATH**/ ?>